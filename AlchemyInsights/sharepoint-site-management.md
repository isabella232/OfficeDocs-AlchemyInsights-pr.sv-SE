...
---
# <a name="sharepoint-online-site-management"></a>Hantering av SharePoint Online-webbplatser

Här är några vanliga ämnen för hantering av SharePoint Online-webbplatser:

- [Hantera webbplatser](https://docs.microsoft.com/sharepoint/manage-sites-in-new-admin-center)
- [Hantera begränsningar för platslagring](https://docs.microsoft.com/sharepoint/manage-site-collection-storage-limits)
