...
Många stora organisationer kommer att behöva planera noggrant för att hantera användarnas förväntningar. Det [du behöver veta om du migrerar IMAP-postlådorna till Microsoft 365](https://docs.microsoft.com/Exchange/mailbox-migration/migrating-imap-mailboxes/migrating-imap-mailboxes) hjälper dig att hantera ändringen.
