---
title: Testa Inline-bilder för Alchemy
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505073"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="b3758-102">Öppna sidan Domäner</span><span class="sxs-lookup"><span data-stu-id="b3758-102">Access the Domains Page</span></span>

<span data-ttu-id="b3758-103">För att komma åt domänsidan, klicka bara på den här ikonen nedan:</span><span class="sxs-lookup"><span data-stu-id="b3758-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="b3758-104">Sedan kan du lägga till, ändra eller ta bort domänen.</span><span class="sxs-lookup"><span data-stu-id="b3758-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="b3758-105">Mer information finns i [vanliga frågor och svar om domäner.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="b3758-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
