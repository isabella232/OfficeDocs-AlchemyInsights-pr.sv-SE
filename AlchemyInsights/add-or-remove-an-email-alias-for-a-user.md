 ...
 **Obs!** du kan ha mer än en e-postadress till en användare, men ytterligare  *e-postalias*  kan bara användas för att ta emot e-post. Om du vill skicka e-post med ett alias skapar du en [delad post låda](https://docs.microsoft.com/microsoft-365/admin/email/create-a-shared-mailbox). På så sätt får du ett alias för att skicka och ta emot e-post.
