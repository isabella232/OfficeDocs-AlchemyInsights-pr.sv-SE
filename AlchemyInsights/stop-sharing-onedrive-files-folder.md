...
---
# <a name="how-to-stop-sharing-onedrive-or-sharepoint-files-or-folders"></a>Så här slutar du dela OneDrive- eller SharePoint-filer eller -mappar

Du kan sluta dela ett objekt, se vem det delas med eller ändra de behörigheter som andra har till det, om du är ägare till objektet.
