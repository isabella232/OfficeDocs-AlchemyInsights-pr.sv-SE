...
2. Leta reda på den prenumeration som du vill återaktivera. Välj **Återaktivera**i avsnittet **Fakturering** .
    ...
    Om du inte ser **Reactivate** som ett alternativ använder du knappen "Behöver du hjälp" för att prata med en supporttekniker för att återaktivera din prenumeration.
