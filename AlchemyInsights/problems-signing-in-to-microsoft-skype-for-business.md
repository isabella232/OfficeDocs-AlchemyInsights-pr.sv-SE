...
Hämta och använda [Support och återställning assistenten (SaRA)](https://aka.ms/SaRA-SkypeForBusinessSignIn). Det här verktyget hjälper dig att diagnostisera och åtgärda ett antal kända problem med att logga in på Skype för företag automatiskt.