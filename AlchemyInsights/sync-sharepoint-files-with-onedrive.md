...
Om du väljer att använda Utforskarvyn i stället för den nya synkroniseringsklienten ska du vara noga med att följa anvisningarna och metodtipsen i artiklarna nedan.

- [Använda kommandot "Öppna med Utforskaren" för felsökning av problem i SharePoint Online](https://support.office.com/article/How-to-use-the-Open-with-Explorer-command-to-troubleshoot-issues-in-SharePoint-Online-87155331-0c92-4224-a4c1-da5c21c4ade4)
...
Obs! Knappen Öppna med Utforskaren visas inte i den nya biblioteksvyn. Klicka på listrutan Visa i det övre högra hörnet (namnet på listrutan ändras beroende på aktuell vy) och klicka sedan på Visa i Utforskaren.
