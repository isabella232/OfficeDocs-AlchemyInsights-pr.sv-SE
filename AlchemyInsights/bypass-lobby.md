...
Om du vill tillåta alla, inklusive fjärråtkomst, externa och anonyma användare att kringgå lobbyn, kan du använda PowerShell för att göra det. Här är ett exempel på hur du ändrar den globala Mötes policyn för din organisation:
